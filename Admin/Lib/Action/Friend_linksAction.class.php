...
class Friend_linksAction extends CommonAction {
	
	public $cmTableName = 'Friend_links';
    ...
    //列表
	public function Friend_links_list(){
	...
	//添加
	public function Friend_links_add(){
	...
	//处理添加的数据（入库）
	public function Friend_links_addok(){
	...
	//编辑页面
	public function Friend_links_edit(){
	...
	//处理编辑的数据（入库）
	public function Friend_links_editok(){
	...
	//根据主建删除一条记录
	public function Friend_links_del(){
	...
	//批量删除
	public function Friend_links_batch_del(){
	...
	//模型Excel
	public function Friend_links_excel(){
