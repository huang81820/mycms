...
class AdvertiseAction extends CommonAction {
	...
	//处理添加的数据（入库）
	public function Advertise_addok(){
	...
	//处理编辑的数据（入库）
	public function Advertise_editok(){
	...
	//批量删除
	public function Advertise_batch_del(){
	...
	//模型Excel
	public function Advertise_excel(){
