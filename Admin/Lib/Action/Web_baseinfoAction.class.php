...
class Web_baseinfoAction extends CommonAction {
	
	public $cmTableName = 'Web_baseinfo';
    ...
    //列表
	public function Web_baseinfo_list(){
	...
	//添加
	public function Web_baseinfo_add(){
	...
	//处理添加的数据（入库）
	public function Web_baseinfo_addok(){
	...
	//编辑页面
	public function Web_baseinfo_edit(){
	...
	//处理编辑的数据（入库）
	public function Web_baseinfo_editok(){
	...
	//根据主建删除一条记录
	public function Web_baseinfo_del(){
	...
	//批量删除
	public function Web_baseinfo_batch_del(){
	...
	//模型Excel
	public function Web_baseinfo_excel(){
