...
<body>
	...
	<div id="com_desc_con">
		<div id="com_desc_con_con">
			...
			<img id="jituan_top_logo" src="__PUBLIC__/statics/default/images/pro_tit2.png"  />
			...
			<div id="nor_con_wrap">
				...
				<ul id="pro_list2" >
				<?php foreach($result as $artRow){ ?>
					<li><a href="<?php echo (CON_PATH); ?>/<?php echo ($artRow[product_id]); ?>/cat_id/<?php echo ($artRow[cat_id]); ?>"><img src="<?php echo ($artRow['thumb']); ?>" /></a></li>
				<?php } ?>	
					<div class="clear"></div>
				</ul>
			</div>
		...
		<div id="com_desc_side">
			<?php $subcat = sub_cat(25) ?>
			<ul id="side_nav">
				<?php foreach($subcat as $subcatRow){ ?>
				<li><a href="<?php echo (CAT_PATH); ?>/<?php echo ($subcatRow[category_id]); ?>"><?php echo ($subcatRow['cat_name']); ?></a></li>
			<?php } ?>	
			</ul>
		</div>
	</div>
