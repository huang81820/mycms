...
<div id="mainbody">
  <div class="info">
    <figure> <img src="__PUBLIC__/statics/default/images/php.jpg"  alt="Panama Hat">
      <figcaption>
	...
	<?php foreach($art['lists'] as $artRow){ ?>
      ...
      <li>
        <div class="arrow_box">
          ...
          <div class="ci"></div>
          <!--圆形-->
          <h2 class="title"><a href="<?php echo (CON_PATH); ?>/<?php echo ($artRow[product_id]); ?>/cat_id/<?php echo ($artRow[cat_id]); ?>" ><?php echo ($artRow['title']); ?></a></h2>
          <ul class="textinfo">
    ...
    <aside>
		<div class="sunnav">
			...
			<?php foreach($subcat as $subcatRow){ ?>
				<li><a  href="<?php echo (CAT_PATH); ?>/<?php echo ($subcatRow[category_id]); ?>"  title="网站建设"><?php echo ($subcatRow['cat_name']); ?></a></li>
			 <?php } ?>
			</ul>
		</div>
      <div class="tuijian">
