...
<div class="content-box-content CM_boxList">
	...
	<div class="tab-content default-tab" id="tab1">
		...
		<form action="<?php echo U('Model/do_edit_list_item');?>" method="post">				
			<table class="add_type add_type">				
				<thead>
					...
					<tr>
						...
						<td><input class="singleErea" type="text" name="item_desc" value="<?php echo ($item["item_desc"]); ?>"/></td>				
					</tr>
					
					<tr>
						<td>排序</td>
						
						<td><input class="singleErea" type="text" value="0" name="item_sort"   value="<?php echo ($item["item_sort"]); ?>" /> </td>				
					</tr>
					
					<?php echo ($expand_input_str); ?>
