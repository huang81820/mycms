		...
		<div id="main-content"> 
			<div class="content-box">
				...
				<div class="content-box-header CM_header">
					...
					<ul id="my_tab">
						<li><a  href="__APP__/Admin/add_role" >添加角色</a></li>
					</ul>
					<div class="clear"></div>
				</div> 
					...
					<div class="tab-content default-tab" id="tab1">
						<table>
							...
							<?php if(is_array($roleList)): foreach($roleList as $key=>$row): ?><tr>
									...
									<td>
										<a href="__APP__/Admin/editor_role/id/<?php echo ($row["id"]); ?>">编辑</a>&nbsp;|
										<a href="__APP__/Admin/access/id/<?php echo ($row["id"]); ?>">配置权限</a>&nbsp;|
										<a href="__APP__/Admin/role_del/id/<?php echo ($row["id"]); ?>">删除</a>
									</td>
