...
<div class="content-box-content CM_boxList">
	...
	<div class="tab-content default-tab" id="tab1">
		<form action="__APP__/Model/set_excel_out_maps" method="POST" >
		<table>
			...
			<tr>
				<td>映射类型:</td>
				<td>
					原样导出：<input type="radio" name="map_type" value="origin" <?php if($mapInfo['map_type'] == 'origin' ): ?>checked="true"<?php endif; ?> checked="true"  />  &nbsp;&nbsp;
			...
			<tr>
				<td>分类列表:</td>
				<td>
					<select class="selectArea" name="map_list_id" >
			...
			<tr>
				<td>导入字段顺序:</td>
				<td>
					<input class="singleErea" type="text" name="excel_out_sort" value="<?php echo $vo['excel_out_sort']==''?'10':$vo['excel_out_sort']; ?>"  />
				</td>
			</tr>
			...
			<tr>
				...
				<?php foreach($mapInfo['map_lists'] as $map_lists_row){ ?>
					<div style="margin-top:4px;">
						值：<input class="singleErea" type="text" name="excel_out_key[]" value="<?php echo ($map_lists_row['key']); ?>" />&nbsp;
						描述：<input class="singleErea" type="text" name="excel_out_desc[]" value="<?php echo ($map_lists_row['desc']); ?>" />&nbsp;
			...
			<div id="DD_ADD_EXCEL_IN_ROW_NEW" style="display:none">
				<div style="margin-top:4px;">
					值：<input class="singleErea" type="text" name="excel_out_key[]" />&nbsp;
					描述：<input class="singleErea" type="text" name="excel_out_desc[]" />&nbsp;
					<span class="DD_ADD_EXCEL_IN_ROW_DELETE" style="color:blue;cursor:pointer;" >[ - ] </span>
				</div>
			</div>
		</table>
