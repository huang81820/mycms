					...
					<td>
						<select name="foreignKey_table" id="FOREIGNKEY_TABLES" class="selectArea" style="float:left">
							...
							<?php foreach($allTables as $singleTable){ ?>
								...
								<option <?php if($inputInfo['column_attrs']['table_name']==$singleTable['table_name']){ echo 'selected="true"';} ?> value="<?php echo $singleTable['table_name'] ?>"><?php echo $singleTable['table_name'] ?></option>
							<?php } ?>
						</select>
						<div id="FOREIGNKEY_COLUMNS_WRAP" style="float:left; margin-left:20px;"><?php echo ($foreignColumn); ?></div>
					</td>
				</tr>
