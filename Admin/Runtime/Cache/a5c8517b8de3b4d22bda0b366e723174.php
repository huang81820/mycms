		...
		<table class="">			
			<tbody>		
				...
				<tr>
					...
					<td>
						是：<input type="radio" name="hidden_time_is_synchronization" value="1" <?php if($inputInfo["column_attrs_string"] == 1): ?>checked="true"<?php endif; ?> />
						否：<input type="radio" name="hidden_time_is_synchronization" value="0" <?php if($inputInfo["column_attrs_string"] == 0): ?>checked="true"<?php endif; ?> />
					</td>
				</tr>
