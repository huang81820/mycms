...
<script type="text/javascript" src="__PUBLIC__/statics/default/js/jquery.js"></script>
<script>
...
<div id="wrap">
	...
	<div id="main_contact">
		<div id="main_contact_con">
			<img src="__PUBLIC__/statics/default/images/qiyedongtai.jpg" />
			<div id="contact_con_left">
				<div id="side_nav_wrap">
					<div id="side_nav_con">
						<img id="about_tit" src="__PUBLIC__/statics/default/images/news_side_tit.png" />
						<ul id="side_nav2" cat_id="<?php echo cat_id(); ?>" >
							<?php $subcat = sub_cat(cat_id()); ?>
			...
			<div id="contact_con_right">
				<div id="contact_con_right_mid">
					...
					<div id="contact_con_con">
						<?php $art = cat2article(cat_id(),$is_all=1,$num=100) ?>
						<ul id="news_list">
							<?php foreach($art['lists'] as $key=>$artRow){ ?>
							<li>
								<a class="news_list_tit" href="<?php echo (CON_PATH); ?>/<?php echo ($artRow[article_id]); ?>/cat_id/<?php echo ($artRow[cat_id]); ?>"><?php echo ($artRow['title']); ?></a>
								<span class="news_list_time"><?php echo date('Y-m-d',$artRow['datetime']); ?></span>
							</li>
							<?php } ?>	
						</ul>
					</div>
