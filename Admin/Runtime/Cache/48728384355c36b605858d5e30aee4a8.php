		...
		<div id="main-content"> 
			<div class="content-box">
				...
				<div class="content-box-header CM_header">
					...
					<ul id="my_tab">
						<li><a  href="__APP__/Admin/add_node" >添加权限</a></li>
					</ul>
					<div class="clear"></div>
				</div> 
				...
				<div class="content-box-content CM_boxList">
					...
					<div class="tab-content default-tab" id="tab1">
						<table>
							...
							<tbody>
							<?php if(is_array($nodeInfo)): foreach($nodeInfo as $key=>$row): ?><tr>
									<td><input class="check-all" type="checkbox" value="<?php echo ($row["id"]); ?>" /></td>
									<td><?php echo ($row["id"]); ?></td>
									<td style="text-indent:<?php echo ($row['level']-1)*20;?>px" ><?php echo ($row["title"]); ?></td>
									<td><?php echo ($row["name"]); ?></td>
									<td><?php echo $row['level']==1?'项目':($val['level']==2?'模块':'操作'); ?></td>
									<td>
										<a href="__APP__/Admin/editor_node/id/<?php echo ($row["id"]); ?>">编辑</a>&nbsp;|
										<a href="__APP__/Admin/del_node/id/<?php echo ($row["id"]); ?>">删除</a>
									</td>
								...
								<tr>
									<td colspan="10">
										<div class="bulk-actions align-left">
											...
											<a class="button CM_selectBtn" href="#">Apply to selected</a>
										</div>
